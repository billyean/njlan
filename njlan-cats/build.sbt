...
val gh = GitHubSettings(org = "io.haiboyan.cats", proj = "njlan-cats", publishOrg = "io.haiboyan.cats", license = apache2)

val mainDev =
  Developer("Haibo Yan", "@yourhandler_without_@", "tristan.yim@gmail.com", new java.net.URL("http://github.com/yourhandler_without_@"))
...
lazy val Njlancats = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeSettings(gh, mainDev,  "njlan-cats"),
    micrositeDocumentationUrl := "/njlan-cats/api/io.haiboyan.cats/index.html",
    micrositeDocumentationLabelDescription := "API Documentation",
    micrositeGithubOwner := "io.haiboyan.cats"
  )
lazy val buildSettings = sharedBuildSettings(gh, libs)

lazy val commonSettings = addCompilerPlugins(libs, "kind-projector") ++ sharedCommonSettings ++ scalacAllSettings ++ Seq(
  organization := "io.haiboyan.cats",
